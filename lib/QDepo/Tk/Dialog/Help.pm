...
QDepo::Tk::Dialog::Help - Dialog for quick help.
...
=head1 SYNOPSIS
    ...
    use QDepo::Tk::Dialog::Help;

    my $fd = QDepo::Tk::Dialog::Help->new;
...
sub new {
    ...
    $self->{cfg} = QDepo::Config->instance();
